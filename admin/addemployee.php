...
<input  name="empcode" id="empcode" onBlur="checkAvailabilityEmpid()" type="text" autocomplete="off" required value = "<?php echo generateRandomString(); ?>" readonly>
...
{   ?>                                            
<option value="<?php echo htmlentities($result->DepartmentShortName);?>"><?php echo htmlentities($result->DepartmentShortName);?></option>
<?php }} ?>
</select>
</div>
